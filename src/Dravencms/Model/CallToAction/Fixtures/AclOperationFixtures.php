...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $operations = [
            'callToAction' => [
                'edit' => 'Umožnuje editaci CallToAction',
                'delete' => 'Umožnuje smazání CallToAction'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\CallToAction\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}